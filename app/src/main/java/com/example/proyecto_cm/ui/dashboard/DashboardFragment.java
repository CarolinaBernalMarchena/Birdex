package com.example.proyecto_cm.ui.dashboard;
...
import com.example.proyecto_cm.databinding.FragmentDashboardBinding;
...
private FragmentDashboardBinding binding;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        //Recuperamos el HashSet de SharedPreferences en el fragmento
        SharedPreferences sharedPref = getActivity().getPreferences(Context.MODE_PRIVATE);
        Set<String> pajarosVistos = sharedPref.getStringSet("pajaros_vistos", new HashSet<>());
        Log.d("hemos visto estos pajaros ", pajarosVistos.toString());
        ...
        myRef.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                for (DataSnapshot snapshot : dataSnapshot.getChildren()) {
                    ...
                    if (!pajarosVistos.contains(nombre)){
                        continue;
                    }
                    ...
                    imageView.setOnClickListener(new View.OnClickListener() {
                        ...
                        public void onClick(View v) { // Ir a otro fragment al hacer clic en la imagen
                            ...
                            navController.navigate(R.id.action_fragmentDashboard_to_fragmentDetails, bundle);
                        }
                    });
